  ...
  <div class="block w-full overflow-x-auto">
      ...
      <table class="items-center w-full bg-transparent border-collapse">
        <thead>
          <tr class="uppercase">
            <th
              class="w-20 px-6 py-3 text-xs font-semibold text-left border border-l-0 border-r-0 border-solid whitespace-nowrap"
            >
            </th>
            <th
              class="px-6 py-3 text-xs font-semibold text-left border border-l-0 border-r-0 border-solid whitespace-nowrap"
            >
              ID
            </th>
            <th
