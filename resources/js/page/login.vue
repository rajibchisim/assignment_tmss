    ...
    <div class="flex flex-grow max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <p class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">Enter your credincials</p>
            ...
            <div class="flex items-center justify-between mt-8">
                ...
                <router-link :to="{ name: 'home' }" class="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</router-link>
